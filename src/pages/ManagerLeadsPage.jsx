...
const blank = { assignee: '', priority: 'Normal', due_date: '', instructions: '', review_notes: '', email_stage: 'initial', recipient_email: '', subject: '', message_body: '', interest_status: 'interested', manager_notes: '', communication_summary: '', closure_reason: '', decision_maker_name: '', decision_maker_role: '', preferred_contact_method: '', next_step: '', next_follow_up_at: '', reason_not_interested: '', conversion_details: '', confirmed: false };
